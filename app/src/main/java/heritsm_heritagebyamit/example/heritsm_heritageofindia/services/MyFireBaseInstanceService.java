package heritsm_heritagebyamit.example.heritsm_heritageofindia.services;
...
public class MyFireBaseInstanceService extends FirebaseMessagingService {
    ...
    private void  showNotification (Map<String,String> data) {
        ...
        String NOTIFICATION_CHANNEL_ID = "heritsm_heritagebyamit.example.services.test";
        ...
        notifiactionBuilder.setAutoCancel ( true )
                ...
                .setSmallIcon ( R.drawable.ajanta )
